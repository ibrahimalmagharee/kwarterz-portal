...
<div class="content-header row">
          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">السلايدر الرئيسي 
                </li>
              </ol>
            </div>
          </div>
    ...
    <div class="card-content collapse show">
            ...
            @endif
            <div class="card-body">
                <form class="form" action="{{route('mainSlider.store')}}" method="post" id="activityForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <label for="projectinput1"> نص   </label>
                                    <textarea type="text" class="form-control ckeditor"   name="text" id="description" required  placeholder="الوصف">{!! !is_null($mainSlider)?$mainSlider->text:'' !!}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                <div class="col-sm-6">
                                @if(!is_null($mainSlider))
                                <img src="{{asset('public/uploads/main-slider/'.$mainSlider->image)}}" width="50%"  height="50%" id="preview_image" class="img-thumbnail">
