                        ...
                        <div class="card-head">
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <a href="{{route('section.create',$course->slug)}}" class="btn btn-primary btn-sm " id="add-section"><i class="ft-plus white"></i>اضافة قسم جديد  </a>
                                </div>
                            </div>
                        </div>
                        <div class="card-content collapse show" id="viewSection">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var sectionTable = $('.section-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{route("section.index",$course->slug)}}",
            columns: [
        ...
        $('body').on('click', '.deleteSection', function(ee) {
            ee.preventDefault();
            ...
            $('#delete').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: '/kwarterz-portal/admin/course/'+course_id+'/section/' + section_id,
                    type: 'delete',
                    data: {
                        "_token": "{{ csrf_token() }}",
                    },
