          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('admin.index')}}">المشرفين</a>
                </li>
                <li class="breadcrumb-item active">{{isset($admin)?'تعديل':'اضافة'}}
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="card-body">
                <form class="form" action="{{isset($admin)?route('admin.update',$admin->id):route('admin.store')}}" method="post" id="newsForm" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="national" class="form-control" placeholder="الجنسية"
                                            name="national" value="{{isset($admin)?$admin->national:old('national')}}">
                                  </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="mobile_number" class="form-control" placeholder="رقم الجوال"
                                            name="mobile_number" value="{{isset($admin)?$admin->mobile_number:old('mobile_number')}}">
                                  </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="form-actions">
                        <button class="btn btn-primary" type="submit"><i class="la la-save"></i> {{isset($admin)?'تعديل':'حفظ'}}</button>
                    </div>
