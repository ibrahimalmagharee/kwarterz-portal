                        ...
                        <div class="card-head">
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <a href="{{route('admin.create')}}" class="btn btn-primary btn-sm " id="add-admin"><i class="ft-plus white"></i>اضافة  مشرف جديد  </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form id="delete_modal_form">
                    ...
                    <div class="modal-body">
                        ...
                        <h5>هل أنت متأكد من حذف هذا المشرف !!</h5>
                    </div>
        ...
        $('body').on('click', '.deleteAdmin', function(ee) {
            ...
            $('#delete').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: '/kwarterz-portal/admin/' + id+'/delete',
                    type: 'delete',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "id": id
