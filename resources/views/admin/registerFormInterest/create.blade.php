...
<div class="content-header row">
    ...
    <div class="card-content collapse show">
            ...
            @endif
            <div class="card-body">
                <form class="form" action="{{route('registration.form.interest.store')}}" method="post" id="newsForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-actions">
                        ...
                        <button class="btn btn-primary" type="submit"><i class="la la-save"></i> اضافة</button>
                    </div>
