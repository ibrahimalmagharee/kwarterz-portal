<a href="#"><i class="feather-settings animation-spin d-inline-block font-xl text-current"></i>
    <div class="menu-dropdown switchcolor-wrap">
        <h4 class="fw-700 font-xs mb-4 text-left">الإعدادات</h4>
         <h6 class="font-xssss text-grey-500 fw-700 mb-3 d-block text-left">اختر تنسيق اللون</h6>
        <ul>
            <li class="ml-0">
        ...
        <div class="card bg-transparent-card border-0 d-block mt-3 text-left">
            <h4 class="d-inline font-xssss mont-font fw-700">لون خلفية العمود الرأسي</h4>
            <div class="d-inline float-right mt-1">
                <label class="toggle toggle-menu-color"><input type="checkbox"><span class="toggle-icon"></span></label>
            </div>
        </div>
        <div class="card bg-transparent-card border-0 d-block mt-3 text-left">
            <h4 class="d-inline font-xssss mont-font fw-700">الوضع المظلم</h4>
            <div class="d-inline float-right mt-1">
