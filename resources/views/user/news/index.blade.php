                        ...
                        @foreach ($news as $new)
                            <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                                <article class="post-article p-0 border-0 shadow-xss rounded-lg overflow-hidden aos-init" data-aos="zoom-in" data-aos-delay="600" data-aos-duration="500" data-aos-once="true">
                                    <a href="{{route('user.show.new', $new->slug)}}"><img src="{{$new->image_path}}" alt="blog-image" class="w-100"></a>
                                    <div class="post-content p-4">
                                        ...
                                        <a href="{{route('user.show.new', $new->slug)}}" class="rounded-xl text-white bg-current w125 p-2 lh-32 font-xsss text-center fw-500 d-inline-block mb-0 mt-2">اقرأ المزيد</a>
                                    </div>
                                </article>
                            </div>
                        @endforeach
