                                ...
                                @foreach ($activities as $activity)
                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                                        <article class="post-article p-0 border-0 shadow-xss rounded-lg overflow-hidden">
                                            <div class="row">
                                                <div class="col-6 col-xs-12"><a href="{{route('user.show.activity', $activity->slug)}}"><img src="{{$activity->image_path}}" alt="blog-image" class="w-100"></a></div>
                                                <div class="col-6 col-xs-12 pl-md--0">
                                                    <div class="post-content p-4">
                                                        ...
                                                        <a href="{{route('user.show.activity', $activity->slug)}}" class="rounded-xl text-white bg-current w125 p-2 lh-32 font-xsss text-center fw-500 d-inline-block mb-0 mt-2">اقرأ المزيد</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </article>
