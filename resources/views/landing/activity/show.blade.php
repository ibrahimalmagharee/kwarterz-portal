    ...
    <div class="main-wrap">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h6 class="text-uppercase fw-600 ls-3 text-success font-xsss">{{$activity->category->name}}</h6>
                        <h2 class="mt-3 mb-2"><a href="#" class="lh-2 display2-size display2-md-size mont-font text-grey-900 fw-700">{{$activity->title}}</a></h2>
                        <h6 class="font-xssss text-grey-500 fw-600 ml-3 mt-3 d-inline-block"><i class="ti-time mr-2"></i> {{ \Carbon\Carbon::parse($activity->created_at)->format('d/m/Y') }}</h6>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="post-image">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <img src="{{$activity->image_path}}" alt="blog-image" class="img-fluid rounded-lg" width="100%">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-left">
                        <p class="lh-34 fw-500 font-xsss drop-cap text-grey-600 mb-5">{!! $activity->description !!}</p>
