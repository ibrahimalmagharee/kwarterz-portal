                            ...
                            <div class="col-xl-8 col-xxl-9 ">
                                <div class="card border-0 mb-0 rounded-lg overflow-hidden" style="background-image: url({{$course->image_path}});">
                                    <div class="card-body p-5 bg-black-08">
                                        ...
                                        <a href="#" class="btn-round-lg d-inline-block rounded-lg bg-greylight"><i class="feather-share-2 font-sm text-grey-700"></i></a>
                                        <a href="{{route('login')}}" class="btn-round-lg mr-2 d-inline-block rounded-lg bg-danger"><i class="feather-bookmark font-sm text-white"></i> </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-xxl-3 ">
                                <div class="card overflow-hidden subscribe-widget p-3 mb-3 rounded-xxl border-0 shadow-xss">
                                    <div class="card-body p-3 d-block text-left">
                                        <h1 class="display1-size text-current fw-700 mb-4">دينار أردني {{$course->price}} <span class="font-xssss text-grey-500 fw-500"> </span></h1>
                                         ...
                                         <a href="{{route('login')}}" class="bg-primary-gradiant border-0 text-white fw-600 text-uppercase font-xssss float-left rounded-lg d-block mt-4 w-100 p-2 lh-34 text-center ls-3 ">شراء الآن</a>
                                    </div>
                                </div>
